...
import StudentImage from "../images/Students.jpg"; // Import student login image
...
const StudentLogin = ({ setUserType }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Cookies.set("studentToken", response.data.token, { expires: 1, path: "/" });
    ...
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-gradient-to-r from-blue-100 to-blue-300">
      <div className="w-full md:w-[40%] h-screen flex items-center justify-center">
        <div className="bg-white p-10 rounded-2xl shadow-2xl max-w-md w-full">
          <h2 className="text-3xl font-extrabold text-center text-gray-800">Student Portal</h2>
          ...
          <p className="text-center text-gray-600 mt-4">
            ...
            <Link to="/studentRegister" className="text-blue-500 font-medium">
              Register Here
            </Link>
          </p>
        </div>
